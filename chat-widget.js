...
(function() {
    ...
    function detectLanguage() {
        // Try to get language from ChatWidgetLang (WordPress localized script)
        ...
        // Try to get from URL or other methods
    ...
    const settings = window.ChatWidgetConfig ? 
        {
            ...
            translations: {
                ...defaultTranslations,
                ...window.ChatWidgetConfig.translations
            }
...
/ /   L a n g u a g e   f i x   a p p l i e d   -   0 6 / 0 5 / 2 0 2 5   1 9 : 1 5 : 1 5  
 