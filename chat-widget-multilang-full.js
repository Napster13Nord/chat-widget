...
(function() {
    ...
    const lang = (window.ChatWidgetConfig?.lang || document.documentElement.lang || 'en').toLowerCase().startsWith('pt') ? 'pt' : 'en';
    const translations = {
        en: {
        ...
        pt: {
            ...
            enterDetails: 'Insira os seus dados para começar a conversar',
            nameLabel: 'Nome',
            namePlaceholder: 'O seu nome',
            emailLabel: 'Email',
            emailPlaceholder: 'O seu email',
            continue: 'Continuar para o chat',
            nameRequired: 'Por favor, insira o seu nome',
            emailRequired: 'Por favor, insira o seu email',
            invalidEmail: 'Por favor, insira um email válido',
            connectionError: 'Desculpe, não foi possível conectar ao servidor. Tente novamente mais tarde.',
    ...
    const welcomeScreenHTML = `
        ...
        <div class="user-registration">
            ...
            <form class="registration-form">
                ...
                <button type="submit" class="submit-registration"' + t.continue + '/button>
            </form>
        </div>
    `;
    ...
    async function submitMessage(messageText) {
        ...
        try {
            ...
            const errorMessage = document.createElement('div');
            errorMessage.className = 'chat-bubble bot-bubble';
            errorMessage.textContent = ' + t.sendError + ';
            messagesContainer.appendChild(errorMessage);
            messagesContainer.scrollTop = messagesContainer.scrollHeight;
        } finally {
